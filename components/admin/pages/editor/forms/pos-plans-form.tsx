...
type Props = {
  value: PosPlansSectionProps
  onChange: (next: PosPlansSectionProps) => void
}

type PlanCard = PosPlansCardItem
...
export function PosPlansForm({ value, onChange }: Props) {
  const [local, setLocal] = useState<PosPlansSectionProps>(value)
  ...
  const set = <K extends keyof PosPlansSectionProps>(
    key: K,
    next: PosPlansSectionProps[K],
  ) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <LocalizedField
        ...
        idPrefix="pos-plans-bottom-message"
      ...
      <div className="space-y-2">
        ...
        <div className="grid gap-2">
          <LocalizedField
            ...
            idPrefix="pos-plans-primary-cta-label"
      ...
      <div className="space-y-2">
        ...
        <div className="grid gap-2">
          <LocalizedField
            label="Texto del botón"
            idPrefix="pos-plans-secondary-cta-label"
      ...
      <div className="space-y-2">
        <Label>Tarjetas POS / PAY (2 por fila)</Label>
        <ItemsField<PlanCard>
          items={local.cards ?? []}

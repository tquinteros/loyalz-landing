...
const AndroidButton = ({ fill = "#754390" }: { fill?: string }) => {
    return (
        <a href="https://play.google.com/store/apps/details?id=com.loyalz.app" target="_blank" className={`hover:opacity-80 transition-opacity duration-300 flex items-center rounded border-2 border-[#754390] w-56 p-1.5 px-3 justify-center gap-2`}>

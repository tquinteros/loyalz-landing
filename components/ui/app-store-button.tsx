...
const AppStoreButton = ({ fill = "#754390" }: { fill?: string }) => {
  return (
    <a
      href="https://apps.apple.com/ar/app/loyalz/id6756419011"
      target="_blank"
      rel="noreferrer"
    ...
    >
      <svg
        ...
        className="h-7 w-6 sm:h-9 sm:w-[30px]"
      >
      ...
      <div className="flex flex-col gap-0">
        <span className={`text-[8px] font-semibold uppercase leading-none sm:text-[9px] ${fill === "#754390" ? "text-chart-5" : "text-background"}`}>
          Descargá loyalz en
        </span>
